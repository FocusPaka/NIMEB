...
# ------------------------------------
pDifferential <- c(0.1,0.3,0.5,0.7)
...
colnames(data) <- c("name","X1","X2","X3","X4")
...
boxplot(X1~name,data,at=0:5,xlim=c(0,26),ylim = c(0,1),ann = F, col = miscolores[1:6], cex.axis = 0.6,las=2)
...
abline(v=20,lty=3,lwd=2,col="pink")
...
colnames(test) <- c("Methods","DE rate=0.1","DE rate=0.3","DE rate=0.5")
